...
familial affect.
The familial effect has a standard deviation approximately equal to the
residual error.
...
The specific effect appears to be small for this locus.
...
so the first will be a kinship effect and the second an uncorrelated random
